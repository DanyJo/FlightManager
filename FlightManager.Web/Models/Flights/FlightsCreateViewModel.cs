...
namespace FlightManager.Web.Models.Flights
{
    ...
    {
        [Required]
        [MaxLength(40, ErrorMessage = "The starting locationcannot cannot be longer than 40 characters")]
        public string StartLocation { get; set; }

        [Required]
        [MaxLength(40, ErrorMessage = "The final locationcannot cannot be longer than 40 characters")]
